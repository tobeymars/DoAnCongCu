...
$ticket = $ticketTypeModel->getTicketTypeById($_GET['id']);

// Kiểm tra nếu vé không tồn tại
if (!$ticket) {
    echo "<script>alert('Vé không tồn tại!'); window.location.href='index.php';</script>";
    exit();
}
?>
<!DOCTYPE html>
...
<body>
    <div class="page-header">
        <div class="container">
            <h1 class="page-title"><i class="fas fa-edit me-2"></i> Chỉnh Sửa Loại Vé</h1>
        </div>
    </div>
        ...
        <div class="form-container">
            <div class="ticket-info">
                ...
                <div class="ticket-details">
                    <p class="ticket-id">Mã vé: #<?= htmlspecialchars($ticket['TicketTypeId']) ?></p>
                    <h4 class="ticket-name"><?= htmlspecialchars($ticket['TicketName']) ?></h4>
                </div>
            </div>

            <div class="card-header mb-4 rounded">
                <i class="fas fa-pen-to-square me-2"></i> Chỉnh sửa thông tin loại vé
            </div>

            <form action="../../Controller/TickettypeController.php?action=update" method="POST" id="ticketForm">
                <input type="hidden" name="TicketTypeId" value="<?= htmlspecialchars($ticket['TicketTypeId']) ?>">
                <input type="hidden" name="EventId" value="<?= htmlspecialchars($ticket['EventId']) ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="text" name="TicketName" id="TicketName" class="form-control" 
                                   value="<?= htmlspecialchars($ticket['TicketName']) ?>" required>
                        </div>
                        <div class="help-text">Tên gọi của loại vé này</div>
                    </div>
                </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="text" name="Price" id="Price" class="form-control" 
                                   value="<?= number_format($ticket['Price'], 0, ',', '.') ?>" required oninput="formatCurrency(this)">
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="number" name="Quantity" id="Quantity" class="form-control" 
                                   value="<?= htmlspecialchars($ticket['Quantity']) ?>" required min="1">
                        </div>
