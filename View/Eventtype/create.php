...
<head>
    ...
    <title>Thêm Loại Sự Kiện Mới</title>
...
<body>
    <div class="card animate-fade-in-down">
        <div class="card-header">
            <h1 class="form-header">Thêm Loại Sự Kiện</h1>
        </div>
        <div class="card-body animate-fade-in" style="animation-delay: 0.1s;">
            <form action="../../controller/EventTypeController.php?action=create" method="POST">
                <div class="mb-4">
                <p class="form-subheader">Vui lòng điền thông tin để tạo loại sự kiện mới</p>
                    ...
                    <div class="form-text">
                        ...
                        Tên loại sự kiện nên ngắn gọn và mô tả chính xác
                    </div>
                </div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            const input = document.getElementById('eventTypeName');
            ...
            if (input.value.trim() === '') {
                ...
                if (!document.querySelector('.invalid-feedback')) {
                    ...
                    errorMsg.innerText = 'Vui lòng nhập tên loại sự kiện';
        ...
        document.getElementById('eventTypeName').addEventListener('input', function() {
            if (this.value.trim() !== '') {
