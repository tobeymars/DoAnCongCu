...
<head>
    ...
    <title>Xác nhận khôi phục địa điểm</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-sync-alt"></i>Xác nhận khôi phục địa điểm</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="info-message">
                ...
                <strong>Thông báo:</strong> Khôi phục sẽ đưa địa điểm này về trạng thái "Còn sử dụng" và nó sẽ xuất hiện trong danh sách địa điểm hoạt động.
            </div>
            
            <form action="../../controller/VenuesController.php?action=restoreVenue" method="POST">
                ...
                <div class="actions">
                    ...
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-sync-alt"></i>Xác nhận khôi phục
                    </button>
                </div>
            </form>
        </div>
